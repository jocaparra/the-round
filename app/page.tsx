...
export default function CanastraStyleHome() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FAFAF8] text-[#1A1210]">
      ...
      {/* 1. HERO INSTITUCIONAL (Estilo Canastra Ventures / Canary) */}
      <section className="relative bg-gradient-to-br from-[#4C0F16] via-[#3B0B11] to-[#5A1119] text-[#F7F2EC] pt-32 sm:pt-44 pb-20 sm:pb-32 px-4 sm:px-6 lg:px-8 border-b border-[#F7F2EC]/10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto space-y-8 text-center sm:text-left">
          {/* Top Badge */}
          <div className="inline-flex items-center space-x-2 bg-[#3B0B11]/90 text-[#D49B5E] border border-[#F7F2EC]/15 px-3.5 py-1 rounded-full text-[11px] font-bold uppercase tracking-widest">
            <span className="w-1.5 h-1.5 rounded-full bg-[#C77B3F] animate-pulse" />
            <span>Jornal Digital Independente</span>
          </div>

          {/* Canastra-style Large Headline */}
          <h1 className="font-['Plus_Jakarta_Sans'] font-extrabold text-4xl sm:text-6xl lg:text-7xl text-[#F7F2EC] tracking-tight leading-[1.08]">
          ...
          {/* Minimal Tagline */}
          <p className="text-base sm:text-xl text-[#D4C7BB] leading-relaxed max-w-2xl font-normal">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4 pt-2">
            <a
              href="#newsletter"
              className="w-full sm:w-auto font-['Plus_Jakarta_Sans'] font-bold text-xs uppercase tracking-wider text-[#F7F2EC] bg-[#C77B3F] hover:bg-[#B06930] px-7 py-3.5 rounded-xl transition-all shadow-lg flex items-center justify-center space-x-2 group"
            >
            ...
            <a
              href="#sobre"
              className="w-full sm:w-auto font-['Plus_Jakarta_Sans'] font-semibold text-xs uppercase tracking-wider text-[#F7F2EC]/90 hover:text-[#F7F2EC] bg-[#3B0B11]/80 hover:bg-[#3B0B11] border border-[#F7F2EC]/20 px-6 py-3.5 rounded-xl transition-all text-center"
            >
              Conheça o Jornal
            </a>
          </div>
      ...
      {/* 2. STATS & LOGOS BAR (Canastra Border Bar) */}
      <section className="bg-[#3B0B11] text-[#F7F2EC] py-8 px-4 border-b border-[#F7F2EC]/10">
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-6 text-center sm:text-left text-xs text-[#D4C7BB]">
            <div>
              <strong className="block font-['Plus_Jakarta_Sans'] text-2xl font-extrabold text-[#F7F2EC]">
                +14.000
              </strong>
              <span className="text-[#D4C7BB]/70">Executivos e founders no LinkedIn</span>
            </div>
            <div className="hidden sm:block w-px h-8 bg-[#F7F2EC]/10" />
            <div>
              <strong className="block font-['Plus_Jakarta_Sans'] text-2xl font-extrabold text-[#D49B5E]">
                R$ 1.8 Bi+
              </strong>
              <span className="text-[#D4C7BB]/70">Em rodadas investigadas</span>
            </div>
            <div className="hidden sm:block w-px h-8 bg-[#F7F2EC]/10" />
            <div>
              <strong className="block font-['Plus_Jakarta_Sans'] text-2xl font-extrabold text-[#F7F2EC]">
              ...
              <span className="text-[#D4C7BB]/70">Jornalismo cético e independente</span>
            </div>
          </div>

          {/* Logo Ticker */}
          <div className="pt-4 border-t border-[#F7F2EC]/10 flex flex-wrap items-center justify-center sm:justify-between gap-6 text-[11px] font-semibold uppercase tracking-widest text-[#D4C7BB]/60">
            <span>COBERTURA DE ECOSSISTEMA:</span>
            <span className="hover:text-[#F7F2EC] transition-colors">Kaszek</span>
            <span className="hover:text-[#F7F2EC] transition-colors">Monashees</span>
            <span className="hover:text-[#F7F2EC] transition-colors">Canary</span>
            <span className="hover:text-[#F7F2EC] transition-colors">Nexus Fintech</span>
            <span className="hover:text-[#F7F2EC] transition-colors">Vortex Logistics</span>
            <span className="hover:text-[#F7F2EC] transition-colors">Solaris</span>
          </div>
        </div>
      </section>

      {/* 3. MANIFESTO INSTITUCIONAL (#sobre) */}
      <section id="sobre" className="py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full space-y-12">
        <div className="space-y-3">
          ...
          <p className="text-base sm:text-lg text-[#574F4B] leading-relaxed">
            Não somos um fundo de venture capital nem uma agência de comunicação. O <strong>The Round</strong> é o veículo jornalístico criado para cobrir a economia de tecnologia no Brasil com a sobriedade e o ceticismo profissional que o mercado exige.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 border-t border-[#1A1210]/10 pt-8">
          <div className="p-6 bg-white rounded-2xl border border-[#1A1210]/10 shadow-sm space-y-2">
            <span className="text-xs font-bold text-[#C77B3F] uppercase tracking-wider block">01</span>
            <h3 className="font-['Plus_Jakarta_Sans'] font-bold text-lg text-[#4C0F16]">
              Cético por Padrão
            </h3>
            <p className="text-xs text-[#574F4B] leading-relaxed">
              Questionamos narrativas ufanistas. Todo dado citado no The Round é checado contra métricas operacionais e fontes cruzadas.
            </p>
          </div>

          <div className="p-6 bg-white rounded-2xl border border-[#1A1210]/10 shadow-sm space-y-2">
            <span className="text-xs font-bold text-[#C77B3F] uppercase tracking-wider block">02</span>
            <h3 className="font-['Plus_Jakarta_Sans'] font-bold text-lg text-[#4C0F16]">
          ...
          <div className="p-6 bg-white rounded-2xl border border-[#1A1210]/10 shadow-sm space-y-2">
            <span className="text-xs font-bold text-[#C77B3F] uppercase tracking-wider block">03</span>
            <h3 className="font-['Plus_Jakarta_Sans'] font-bold text-lg text-[#4C0F16]">
      ...
      {/* 4. ESCOPO EDITORIAL (#escopo) - Canastra Numbered Grid */}
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 sm:p-8 rounded-2xl border border-[#1A1210]/10 space-y-2 shadow-sm">
              <span className="font-['Plus_Jakarta_Sans'] text-2xl font-extrabold text-[#C77B3F] block">
                01
              </span>
              <h3 className="font-['Plus_Jakarta_Sans'] font-bold text-lg text-[#1A1210]">
                Rodadas & M&A
              </h3>
              <p className="text-xs text-[#574F4B] leading-relaxed">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl border border-[#1A1210]/10 space-y-2 shadow-sm">
              ...
              <p className="text-xs text-[#574F4B] leading-relaxed">
                Downrounds silenciosos, inadimplência em crédito B2B e reestruturações do mercado de tecnologia.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* 5. LINHA EDITORIAL (#manifesto) - Canastra Quote Style */}
      <section id="manifesto" className="py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full space-y-10">
        <div className="space-y-2">
          <span className="text-xs font-bold uppercase tracking-widest text-[#C77B3F]">
            Linha Editorial
          </span>
        ...
        <div className="bg-white p-8 sm:p-12 rounded-3xl border border-[#1A1210]/10 shadow-sm space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4 text-xs text-[#574F4B]">
            <div className="space-y-1">
              <strong className="text-[#1A1210] font-bold block text-sm">Fonte Única no LinkedIn</strong>
              <p>O site é a matriz das matérias e o LinkedIn é nosso canal primário de distribuição direta.</p>
            </div>
            <div className="space-y-1">
              <strong className="text-[#1A1210] font-bold block text-sm">Zero Releases Reciclados</strong>
              <p>Todas as informações são checadas com fontes operacionais e investidores.</p>
            </div>
            <div className="space-y-1">
              <strong className="text-[#1A1210] font-bold block text-sm">Autoria Anônima</strong>
      ...
      {/* 6. LINKEDIN CALLOUT (Canastra Action Card) */}
      <section className="bg-gradient-to-r from-[#4C0F16] to-[#3B0B11] text-[#F7F2EC] py-16 px-4 sm:px-6 lg:px-8 border-t border-b border-[#F7F2EC]/10">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-8">
          <div className="space-y-2 text-center sm:text-left">
            ...
            <p className="text-xs sm:text-sm text-[#D4C7BB] max-w-xl">
          ...
          <a
            ...
            className="inline-flex items-center space-x-3 bg-[#C77B3F] hover:bg-[#B06930] text-[#F7F2EC] font-bold text-xs uppercase tracking-wider px-7 py-4 rounded-xl transition-all shadow-lg flex-shrink-0 group"
          >
      ...
      {/* 7. NEWSLETTER CAPTURE (#newsletter) */}
      <section id="newsletter" className="py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#4C0F16] via-[#3B0B11] to-[#5A1119] text-[#F7F2EC] p-8 sm:p-14 border border-[#F7F2EC]/15 shadow-2xl space-y-8 text-center sm:text-left">
          ...
          <div className="relative z-10 space-y-3 max-w-2xl">
            <div className="inline-flex items-center space-x-2 bg-[#C77B3F]/20 text-[#D49B5E] border border-[#C77B3F]/40 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
              <Mail className="w-3.5 h-3.5" />
              <span>Newsletter Exclusiva do The Round</span>
            </div>

            <h2 className="font-['Plus_Jakarta_Sans'] font-extrabold text-3xl sm:text-4xl text-[#F7F2EC] leading-tight tracking-tight">
              O briefing que a Faria Lima e os founders leem antes de abrir o mercado.
            </h2>

            <p className="text-xs sm:text-sm text-[#D4C7BB] leading-relaxed">
          ...
          <div className="relative z-10 pt-2">
            {submitted ? (
              <div className="bg-[#5A1119] border border-[#C77B3F] p-6 rounded-2xl max-w-lg flex items-center space-x-3 text-left shadow-lg">
                ...
                <div>
                  <h4 className="font-bold text-sm text-[#F7F2EC]">Inscrição Realizada com Sucesso!</h4>
              ...
              >
                <div className="relative w-full">
                  <input
                    ...
                    className="w-full bg-[#3B0B11]/90 text-[#F7F2EC] placeholder-[#D4C7BB]/50 px-4 py-3.5 rounded-xl border border-[#F7F2EC]/20 focus:outline-none focus:border-[#C77B3F] transition-all text-xs font-medium"
                  />
                </div>
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full sm:w-auto font-['Plus_Jakarta_Sans'] font-bold text-xs uppercase tracking-wider text-[#F7F2EC] bg-[#C77B3F] hover:bg-[#B06930] px-7 py-3.5 rounded-xl transition-all shadow-md flex items-center justify-center space-x-2 flex-shrink-0 disabled:opacity-50"
                >
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-4 flex flex-col space-y-3">
              <a
                ...
                className="w-full text-center bg-[#C77B3F] hover:bg-[#B06930] text-[#F7F2EC] font-bold text-xs uppercase tracking-wider py-3.5 px-4 rounded-xl transition-all shadow-md flex items-center justify-center space-x-2"
              >
